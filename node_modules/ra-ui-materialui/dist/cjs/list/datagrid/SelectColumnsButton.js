...
var SelectColumnsButton = function (props) {
    ...
    var availableColumns = (0, ra_core_1.useStore)("".concat(preferenceKey, ".availableColumns"), [])[0];
    var omit = (0, ra_core_1.useStore)("".concat(preferenceKey, ".omit"), [])[0];
    var _b = (0, ra_core_1.useStore)("".concat(preferenceKey, ".columns"), availableColumns
    ...
    return (React.createElement(React.Fragment, null,
        isXSmall ? (React.createElement(material_1.Tooltip, { title: title },
            React.createElement(material_1.IconButton, { "aria-label": title, color: "primary", onClick: handleClick, size: "large" },
                React.createElement(ViewWeek_1.default, null)))) : (React.createElement(material_1.Button, { size: "small", onClick: handleClick, startIcon: React.createElement(ViewWeek_1.default, null), sx: { '&.MuiButton-sizeSmall': { lineHeight: 1.5 } } }, title)),
        React.createElement(material_1.Popover, { open: Boolean(anchorEl), anchorEl: anchorEl, onClose: handleClose, anchorOrigin: {
            ...
            React.createElement(material_1.Box, { p: 1 }, availableColumns.map(function (column) { return (React.createElement(FieldEditor_1.FieldEditor, { key: column.index, source: column.source, label: column.label, index: column.index, selected: columns.includes(column.index), onToggle: handleToggle })); })))));
};
