...
export var SelectColumnsButton = function (props) {
    ...
    return (React.createElement(React.Fragment, null,
        isXSmall ? (React.createElement(Tooltip, { title: title },
            React.createElement(IconButton, { "aria-label": title, color: "primary", onClick: handleClick, size: "large" },
                React.createElement(ViewWeekIcon, null)))) : (React.createElement(Button, { size: "small", onClick: handleClick, startIcon: React.createElement(ViewWeekIcon, null), sx: { '&.MuiButton-sizeSmall': { lineHeight: 1.5 } } }, title)),
